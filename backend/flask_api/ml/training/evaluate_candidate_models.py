...
REPORT_PATH = ML_REPORTS_DIR / "candidate_model_evaluation_report.txt"
FAILED_FEED_REPORT_PATH = ML_REPORTS_DIR / "feed_model_report.txt"
...
MILK_DATASET = MILK_YIELD_DATASET_PATH
DISEASE_DATASET = DISEASE_DATASET_PATH
...
def load_dataset(path: Path) -> pd.DataFrame:
    if not path.is_file():
        raise FileNotFoundError(
            ...
            "Place the CSV file in the project-root datasets/raw folder."
        )
